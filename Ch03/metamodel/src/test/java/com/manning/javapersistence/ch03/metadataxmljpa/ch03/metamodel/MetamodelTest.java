package com.manning.javapersistence.ch03.metadataxmljpa.ch03.metamodel;
...
public class MetamodelTest {
    ...
    @Test
    public void testItemPatternWithGeneratedClass(){
        EntityManager em = emf.createEntityManager();
        deleteItems(em);
        persistItem(em);
    ...
    private void persistItem(EntityManager em) {
        em.getTransaction().begin();
        Item item1 = new Item();
    ...
    private Date tomorrow(){return new Date(new Date().getTime() + (1000 * 60 * 60 * 24));}
